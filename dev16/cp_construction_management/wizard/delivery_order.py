...
class PickingWizard(models.TransientModel):
    ...
    def _prepare_delivery_order(self):
        self.ensure_one()
        material_req_obj = self.env['cp_construction_management.material_req'].browse(self._context.get('active_ids', []))
    ...
    def create_delivery_order(self):
        ...
        material_req = self.env['cp_construction_management.material_req'].browse(self._context.get('active_ids', []))

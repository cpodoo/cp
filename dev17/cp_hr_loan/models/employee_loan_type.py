...
class employee_loan_type(models.Model):
    ...
    def get_action_loan_done(self):
        return self._get_action('cp_hr_loan.action_loan_done')

    def get_action_loan_draft(self):
        return self._get_action('cp_hr_loan.action_loan_draft')

...
class ReportRoomBookingPDF(models.AbstractModel): 
    _name = 'report.cp_hotel_management.report_room_booking'
    _description = 'Room Booking PDF Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if data and 'booking' in data:
            booking_details = data.get('booking')
            docs = self.env['room.booking.detail'].browse(docids)
            report_model_name = 'room.booking.detail'
        elif docids:
             pass

        return {
            'doc_ids': docids,
            'doc_model': report_model_name if docs else 'room.booking.detail',
            'docs': docs,

...
class ResPartner(models.Model):
    ...
    profile_msg = fields.Html(string="Profile Message", copy=False)
    ...
    seller_contact_ids  = fields.One2many('res.partner', 'parent_id', string='Related Contacts')
    ...
    #     ('pvt_ltd', 'Pvt Ltd'),
    #     ('llp', 'LLP'),
    #     ('ltd', 'Ltd'),('proprietorship','Proprietorship'),('partnership','Partnership')
    # ], string="Business Type")
    # tan = fields.Char(string="TAN")
    # gstin = fields.Char(string="GSTIN")
    # pan = fields.Char(string="PAN")
    # business_address_line1 = fields.Char(string="Address Line 1")
    # business_address_line2 = fields.Char(string="Address Line 2")
    # business_city = fields.Char(string="City")
    # business_pincode = fields.Char(string="Pincode")
